...
export class RegionFormViewComponent implements OnInit, OnChanges {
    ...
    @Output() addRegion = new EventEmitter<Region>();
    ...
    ngOnChanges(changes: SimpleChanges): void {
        if (changes.buildings?.currentValue) {
            ...
            this.buildingList = this.buildingList.sort((a, b) => a.buildingName - b.buildingName);
        }
    ...
    onAdd(): void {
        if (this.regionForm.valid) {
            this.addRegion.emit(this.regionForm.value);
        }
    }
